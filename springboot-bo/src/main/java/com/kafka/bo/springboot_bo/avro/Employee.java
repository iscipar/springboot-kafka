 ...
 */
package com.kafka.bo.springboot_bo.avro;
...
public class Employee extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7736499043451509306L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Employee\",\"namespace\":\"com.kafka.bo.springboot_bo.avro\",\"fields\":[{\"name\":\"id\",\"type\":\"string\"},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"department\",\"type\":\"string\"}]}");
   ...
   */
  public Employee(java.lang.CharSequence id, java.lang.CharSequence name, java.lang.CharSequence department) {
    this.id = id;
    this.name = name;
   ...
   */
  public static com.kafka.bo.springboot_bo.avro.Employee.Builder newBuilder() {
    return new com.kafka.bo.springboot_bo.avro.Employee.Builder();
  }
   ...
   * @return A new Employee RecordBuilder
   */
  public static com.kafka.bo.springboot_bo.avro.Employee.Builder newBuilder(com.kafka.bo.springboot_bo.avro.Employee.Builder other) {
    if (other == null) {
      return new com.kafka.bo.springboot_bo.avro.Employee.Builder();
    } else {
      return new com.kafka.bo.springboot_bo.avro.Employee.Builder(other);
    }
  }
   ...
   * @return A new Employee RecordBuilder
   */
  public static com.kafka.bo.springboot_bo.avro.Employee.Builder newBuilder(com.kafka.bo.springboot_bo.avro.Employee other) {
    if (other == null) {
      return new com.kafka.bo.springboot_bo.avro.Employee.Builder();
    } else {
      return new com.kafka.bo.springboot_bo.avro.Employee.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Employee>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.kafka.bo.springboot_bo.avro.Employee.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.kafka.bo.springboot_bo.avro.Employee other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.bo.springboot_bo.avro.Employee.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.bo.springboot_bo.avro.Employee.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.bo.springboot_bo.avro.Employee.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.bo.springboot_bo.avro.Employee.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.bo.springboot_bo.avro.Employee.Builder setDepartment(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.kafka.bo.springboot_bo.avro.Employee.Builder clearDepartment() {
      department = null;
